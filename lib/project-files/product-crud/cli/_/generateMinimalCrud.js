...
async function generateMinimalCrud(entity) {
  ...
  const directories = ['models', 'controllers', 'routes'];
  ...
  try {
    ...
    console.log(`Added routes for ${entity} in server.js at line 37`);
  } catch (error) {
    console.error('Error generating minimal CRUD:', error);
  }
}
