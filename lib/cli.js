...
const templates = [
  {
    name: "Basic Project 🌱",
    description: "A basic Express.js project with Node.js and MongoDB setup.",
    directory: "basic-project",
  },
  {
    name: "User CRUD 🚀",
    description: "An Express.js project with user CRUD operations.",
    directory: "user-crud",
  },
  {
    name: "Full Stack User Authentication 🔒",
    description:
      "An Express.js project with user CRUD operations and JWT authentication.",
